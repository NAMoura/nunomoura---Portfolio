  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg img */}
        <div className="bg-none xl:bg-explosion xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge -bottom-12 translate-z-0 opacity-60 animate-pulse duration-75"></div>
        <div>
          {/* particles */}
          <ParticleContainer />
          {/* avatar img */}
